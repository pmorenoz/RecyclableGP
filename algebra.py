# Based on gptorch.functions.py by Steven Atkinson (steven@atkinson.mn)
# ------------------------------------------------
...
# ------------------------------------------------
"""
``gptorch.algebra`` contains self-defined functions subclassing
...
def jit_op(op, x: torch.Tensor, max_tries: int = 10, verbose: bool = False) -> torch.Tensor:
    """
